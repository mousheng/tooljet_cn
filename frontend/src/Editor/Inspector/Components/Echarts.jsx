      ...
      if (chartType !== 'pie') {
        ...
        if (!plotFromJson) {
          items.push({
            ...
            children: (
              <>
                {renderElement(component, componentMeta, paramUpdated, dataQueries, 'showXAxes', 'properties', currentState)}
                {renderElement(component, componentMeta, paramUpdated, dataQueries, 'showYAxes', 'properties', currentState)}
                {renderElement(
                  component,
                  componentMeta,
                  paramUpdated,
