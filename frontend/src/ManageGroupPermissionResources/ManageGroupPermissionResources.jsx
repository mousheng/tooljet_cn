              ...
              <div className="justify-content-between d-flex groups-main-header-wrap">
                ...
                {(groupPermission.group == 'admin' || groupPermission.group == 'all_users') && (
                  <div className="default-group-wrap">
                    ...
                    <p className="font-weight-500 tj-text-xsm">默认组</p>
                  </div>
                )}
                {groupPermission.group !== 'admin' && groupPermission.group !== 'all_users' && (
                  <div className="user-group-actions">
                    ...
                    <Link
                      ...
                      data-cy="delete-link"
                    >
                      <SolidIcon fill="#E54D2E" name="trash" width="14" /> 删除组
                    </Link>
                  </div>
                )}
              </div>
                          ...
                          {groupPermission.group == 'admin' && (
                            <div className="manage-group-users-info">
                              <p className="tj-text-xsm">
                                <SolidIcon name="information" fill="#3E63DD" /> 管理员可以编辑所有应用程序
                              </p>
                            </div>
                          )}
                          <div className="groups-app-body-header d-flex">
                            <p className="font-weight-500 tj-text-xsm">应用程序名称</p>
                            <p className="font-weight-500 tj-text-xsm">权限</p>
                          </div>
                              ...
                              <>
                                {appsInGroup?.length > 0 ? (
                                  ...
                                  <div className="manage-groups-no-apps-wrap">
                                    ...
                                    <p className="tj-text-md font-weight-500">未将任何应用添加到组中</p>
                  ...
                  <div className={`tab-pane ${currentTab === 'users' ? 'active show' : ''}`}>
                      ...
                      <div className="row">
                        ...
                        <div className="row mt-2">
                          <div className="selected-section">
                            <div className="selected-text">选定的用户:</div>
                    ...
                    <div>
                      {groupPermission.group == 'all_users' && (
                        <div className="manage-group-users-info">
                          <p className="tj-text-xsm">
                            <SolidIcon name="information" fill="#3E63DD" /> 所有用户包括应用程序中的每个用户.
                            此列表不可编辑
                          </p>
                        </div>
                      )}
                      ...
                      <div>
                        <div>
                          {groupPermission.group == 'admin' && (
                            <div className="manage-group-users-info">
                              <p className="tj-text-xsm">
                                <SolidIcon name="information" fill="#3E63DD" /> 管理员拥有所有权限
                              </p>
                            </div>
                          )}
